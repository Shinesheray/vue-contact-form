# PHP Laravel and Vuejs contact form

This Contact form is created to send information to the Database and to send an email to mailtrap the contact detail information
